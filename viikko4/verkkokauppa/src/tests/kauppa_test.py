...
class TestKauppa(unittest.TestCase):
    ...
    def test_ostoksen_jalkeen_tilisiirto_kutsutaan_oikein(self):
        def varasto_saldo(tuote_id):
            if tuote_id == 1:
                return 10
    ...
    def test_eri_tuotteiden_ostoksen_jalkeen_tilisiirto_kutsutaan_oikein(self):
        def varasto_saldo(tuote_id):
            if tuote_id == 1:
                return 10
            if tuote_id == 2:
    ...
    def test_samojen_tuotteiden_ostoksen_jalkeen_tilisiirto_kutsutaan_oikein(self):
        def varasto_saldo(tuote_id):
            if tuote_id == 1:
                return 10
    ...
    def test_loppuneen_tuotteen_ostoksen_jalkeen_tilisiirto_kutsutaan_oikein(self):
        def varasto_saldo(tuote_id):
            if tuote_id == 1:
                return 10
            if tuote_id == 2:
    ...
    def test_tuotteiden_poisto_ostoskorista_onnistuu(self):
        def varasto_saldo(tuote_id):
            if tuote_id == 1:
                return 10
            if tuote_id == 2:
